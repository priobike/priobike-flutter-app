...
class StatusViewState extends State<StatusView> {
  ...
  Future<String?> loadProblem() async {
    ...
    } else if (status.numPredictions != 0 &&
    ...
    } else if (status.averagePredictionQuality != null &&
      ...
      child: Padding(
        ...
        child: Tile(
          ...
          onPressed: () => Navigator.push(context,
              MaterialPageRoute(builder: (context) => const SGStatusMapView())),
                  ...
                  children: [
                    problem != null
                        ? BoldContent(
                            ...
                            color: Colors.white)
                        : BoldContent(
                            text: "Aktuelle Datenlage", context: context),
