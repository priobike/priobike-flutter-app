...
import 'package:priobike/common/map/view_new.dart';
...
class SGStatusMapViewState extends State<SGStatusMapView> {
  ...
  Future<void> onStyleLoaded(mapbox.StyleLoadedEventData styleLoadedEventData) async {
    ...
    await mapController?.style.styleSourceExists("sg-locs").then((value) async {
      if (!value) {
    ...
    await mapController?.style.styleSourceExists("sg-lanes").then((value) async {
      if (!value) {
        await mapController?.style.addSource(
          mapbox.GeoJsonSource(
    ...
    await mapController?.style.styleLayerExists("sg-lines").then((value) async {
      if (!value) {
        await mapController?.style.addLayer(
          mapbox.LineLayer(
            sourceId: "sg-lanes",
    ...
    await mapController?.style.styleLayerExists("sg-first-labels").then((value) async {
      if (!value) {
        await mapController?.style.addLayer(
          mapbox.SymbolLayer(
            sourceId: "sg-locs",
    ...
    await mapController?.style.styleLayerExists("sg-second-labels").then((value) async {
      if (!value) {
        await mapController?.style.addLayer(
          mapbox.SymbolLayer(
            sourceId: "sg-locs",
