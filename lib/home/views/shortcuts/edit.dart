...
class EditOptionsViewState extends State<EditOptionsView> {
  ...
  Future<void> onShareShortcut(int idx) async {
    ...
    const playStoreLink = 'http://play.google.com/store/apps/details?id=de.tudresden.priobike&hl=de';
    const appStoreLink = 'http://apps.apple.com/de/app/priobike/id1634224594';
    String subject = '';
