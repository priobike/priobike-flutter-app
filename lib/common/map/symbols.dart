...
class SymbolLoader {
  ...
  Future<void> loadSymbols() async {
    ...
    await add("airdark", "assets/images/air-dark.png", 201, 201);
    await add("airlight", "assets/images/air-light.png", 201, 201);
    await add("constructiondark", "assets/images/construction-dark.png", 201, 201);
    await add("constructionlight", "assets/images/construction-light.png", 201, 201);
    await add("parkdark", "assets/images/park-dark.png", 201, 201);
    await add("parklight", "assets/images/park-light.png", 201, 201);
    ...
    await add("rentdark", "assets/images/rent-dark.png", 201, 201);
    await add("rentlight", "assets/images/rent-light.png", 201, 201);
    await add("repairdark", "assets/images/repair-dark.png", 201, 201);
    ...
    await add("route-label-primary-left", "assets/images/route-label-primary-left.png", 200, 63);
    await add("route-label-primary-right", "assets/images/route-label-primary-right.png", 200, 63);
    await add("route-label-primary-top", "assets/images/route-label-primary-top.png", 150, 113);
    await add("route-label-primary-bottom", "assets/images/route-label-primary-bottom.png", 150, 113);
