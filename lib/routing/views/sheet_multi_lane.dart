...
class RouteDetailsMultiLaneBottomSheet extends StatefulWidget {
  ...
  const RouteDetailsMultiLaneBottomSheet(
      {required this.onSelectStartButton, required this.onSelectSaveButton, Key? key})
      : super(key: key);

  @override
  State<StatefulWidget> createState() => RouteDetailsMultiLaneBottomSheetState();
}

class RouteDetailsMultiLaneBottomSheetState extends State<RouteDetailsMultiLaneBottomSheet> {
  /// The associated routing service, which is injected by the provider.
  late RoutingMultiLane routing;
  ...
  void initState() {
    ...
    routing = getIt<RoutingMultiLane>();
