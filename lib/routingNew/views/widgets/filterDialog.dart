                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        BoldContent(
                            text: profileService?.bikeType?.description() ?? "",
                            context: context),
                      ],
                    ),
                    Container(height: 5),
                      ...
                      children: [
                        Expanded(
                          child: TextButton(
                            ...
                            style: TextButton.styleFrom(
                              backgroundColor: profileService?.preferenceType ==
                                      PreferenceType.fast
                                  ? Theme.of(context).colorScheme.primary
                                  : Theme.of(context).colorScheme.background,
                              shape: const RoundedRectangleBorder(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Switch(
                          value: profileService?.showTrafficLights ?? false,
                          onChanged: (value) {
                            setState(() {
                              profileService?.showTrafficLights =
                                  profileService.showTrafficLights != null
                                      ? !profileService.showTrafficLights!
                                      : true;
                              profileService?.store();
                            });
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Switch(
                          ...
                          onChanged: (value) {
                            setState(() {
                              profileService?.avoidTrafficLights =
                                  profileService.avoidTrafficLights != null
                                      ? !profileService.avoidTrafficLights!
                                      : true;
                              profileService?.store();
                            });
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Switch(
                          ...
                          onChanged: (value) {
                            setState(() {
                              profileService?.avoidAscents =
                                  profileService.avoidAscents != null
                                      ? !profileService.avoidAscents!
                                      : true;
                              profileService?.store();
                            });
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Switch(
                          ...
                          onChanged: (value) {
                            setState(() {
                              profileService?.avoidTraffic =
                                  profileService.avoidTraffic != null
                                      ? !profileService.avoidTraffic!
                                      : true;
                              profileService?.store();
                            });
