...
class GNSSPositionSource extends PositionSource {
  ...
  @override
  Future<bool> isLocationServicesEnabled() async => Geolocator.isLocationServiceEnabled();
  ...
  @override
  Future<void> stopPositioning() async => {/* Not supported by flutter geolocator? */};

  /// Open the location settings.
  @override
  Future<bool> openLocationSettings() async => Geolocator.openLocationSettings();
}
