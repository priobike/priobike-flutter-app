    ...
    return Scaffold(
        ...
        body: ListView(
          children: <Widget>[
            ...
            StreamBuilder<bool>(
              ...
              builder: (context, snapshot) {
                return SwitchListTile(
                  ...
                  value: snapshot.data,
                  onChanged: (bool newValue) => settingsBloc.setRacer.add(newValue),
                );
              }
            ),
            ListTile(
            ...
            StreamBuilder<bool>(
              ...
              builder: (context, snapshot) {
                return SwitchListTile(
                  ...
                  value: snapshot.data,
                  onChanged: (bool newValue) => settingsBloc.setDynamicLocation.add(newValue)
                );
              },
            ),
            StreamBuilder<bool>(
              ...
              builder: (context, snapshot) {
                return SwitchListTile(
                    ...
                    value: snapshot.data,
                    onChanged: (bool newValue) => settingsBloc.setOptimiyeSystemTime.add(newValue)
                );
              },
            ),
            StreamBuilder<bool>(
              ...
              builder: (context, snapshot) {
                return SwitchListTile(
                    ...
                    value: snapshot.data,
                    onChanged: (bool newValue) => settingsBloc.setSlowlyHideTrafficLightPhase.add(newValue)
                );
              },
            ),
            StreamBuilder<bool>(
              ...
              builder: (context, snapshot) {
                return SwitchListTile(
                    ...
                    subtitle: Text(
                        "Zeigt dir die Genauigkeit deiner GPS Daten an."
                    ),
                    value: snapshot.data,
                    onChanged: (bool newValue) => settingsBloc.setShowGPSAccuracy.add(newValue)
                );
              },
            ),
            ...
            StreamBuilder<bool>(
              ...
              builder: (context, snapshot) {
                return SwitchListTile(
                    ...
                    value: snapshot.data,
                    onChanged: (bool newValue) => settingsBloc.setDebugMode.add(newValue)
                );
              },
            ),
            ...
            SettingsSectionHeader('Simulator Eeinstellungen'),
            ...
            StreamBuilder<bool>(
              ...
              builder: (context, snapshot) {
                return SwitchListTile(
                    ...
                    value: snapshot.data,
                    onChanged: (bool newValue) => settingsBloc.setPushLocations.add(newValue)
                );
              },
            ),
            StreamBuilder<bool>(
              ...
              builder: (context, snapshot) {
                return SwitchListTile(
                    ...
                    value: snapshot.data,
                    onChanged: (bool newValue) => settingsBloc.setSimulator.add(newValue)
                );
              },
            )
          ],
