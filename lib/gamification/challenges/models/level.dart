...
List<Level> levels = [
  ...
  const Level(value: 25, title: 'Rad-Rookie', color: LevelColors.pink),
  const Level(value: 100, title: 'Freizeitradler', color: LevelColors.green),
  const Level(value: 250, title: 'Sattel-Routinier', color: LevelColors.bronze),
